                ...
                <div class="hero-card">
                    <div class="hero-card-header">
                        @if(optional($profile)->photo_url)
                            <img src="{{ $profile->photo_url }}" alt="{{ $profile->name }}" style="width:64px;height:64px;border-radius:16px;object-fit:cover;margin-bottom:16px;border:2px solid rgba(255,255,255,.3);">
                        @else
        ...
        <div class="grid-3">
            ...
            <article class="card" style="padding:0;overflow:hidden;">
                ...
                <div style="padding:20px;">
                    ...
                    <p style="font-size:13px;color:#64748b;line-height:1.6;">{{ $portfolio->description }}</p>
                </div>
            </article>
            @empty
            @foreach([
